 ...
 */
package com.manuelpeinado.multichoiceadapter.samples.actionbarsherlock.manyitemssample;
...
public class CountriesAdapter extends MultiChoiceBaseAdapter {
    protected static final String TAG = CountriesAdapter.class.getSimpleName();
    private List<String> items;

    public CountriesAdapter(Bundle savedInstanceState, List<String> items) {

 ...
 */
package com.manuelpeinado.multichoiceadapter.samples.actionbarsherlock.customactionmodetitlesample;
...
public class CustomActionModeTitleActivity extends SherlockActivity
                                  implements OnItemClickListener {
    private CustomActionModeTitleAdapter adapter;
    ...
    private void rebuildList(Bundle savedInstanceState) {
        ...
        adapter = new CustomActionModeTitleAdapter(savedInstanceState, this, items);

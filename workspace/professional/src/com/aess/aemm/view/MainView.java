...
//		hall_layout.setBackgroundResource(id);
		...
		if (DEBUG) {
			...
			ViewUtils
					.addMessage(
							this,
							new HallMessagedb(
									"dfsfsdfsfasdfsafasfasfsafsfsafsfdfadsfa锟斤拷锟斤拷锟斤拷息2锟斤拷停锟斤拷dfsfsdfsfasdfsafasfasfsafsfsafsfdfadsfadadfsfsdfsfasdfsaffadfsfsdfsfasdfsafasfasfsafsfsaf",
									1000, 10000, 1000, 2));
			ViewUtils
					.addMessage(
							this,
							new HallMessagedb(
									"息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷锟斤拷锟斤拷锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷息2锟斤拷停锟斤拷",
									1000, -1, 1000, 23));
			ViewUtils
					.addMessage(
							this,
							new HallMessagedb(
									"re锟斤拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟斤拷",
									1000, -1, 5000, 12));
			// ViewUtils.addMessage(this,new HallMessagedb(
			// "锟斤拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟斤拷remoall",
			// 14));
			// ViewUtils.addMessage(this,new HallMessagedb(
			// "remoall锟斤拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟斤拷remoall",
			// 11));
			for (int i = 0; i < 40; i++) {
				AppItem app = new AppItem(
						i
								+ "锟斤拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟斤拷",
				...
				app = new AppItem(
						...
						"锟斤拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟揭憋拷锟斤拷锟斤拷DescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreiptDescreipt");
	...
	public void onClick(View v) {
		...
		case R.id.add_app_btn:
			AppItem app = new AppItem("锟斤拷锟斤拷锟斤拷", Utils.ICONPATH
		...
		case R.id.del_app_btn:
			appAdapterSl.deleteItemByApkId("锟斤拷锟斤拷锟斤拷", null);
			break;
		...
		case R.id.del_apk_btn:
			apkAdapterSl.deleteItemByApkId("锟斤拷锟斤拷锟斤拷", null);
			break;
		}
	}

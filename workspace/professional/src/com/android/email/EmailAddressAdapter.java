...
public class EmailAddressAdapter extends ResourceCursorAdapter {
    ...
    public EmailAddressAdapter(Context context) {
        super(context,0x7f03001b, null);// R.layout.recipient_dropdown_item, null);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        TextView text1 = (TextView)view.findViewById(0x7f0d006d);//R.id.text1);
        TextView text2 = (TextView)view.findViewById(0x7f0d006e);//R.id.text2);

...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String TAG_FAVORITES_BAR_ICON = "favorites-bar-icon";
        ...
        private int loadFavorites(SQLiteDatabase db) {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    values.clear();       
                    // AAD 10/2/2011 - Specical case the container for favorites bar icons.
                    if (TAG_FAVORITES_BAR_ICON.equals(name)) {
	                    values.put(LauncherSettings.Favorites.CONTAINER,
	                            LauncherSettings.Favorites.CONTAINER_FAVORITES_BAR);
                    }
                    else {
	                    values.put(LauncherSettings.Favorites.CONTAINER,
                    ...
                    // AAD 10/2/2011 - Apart from the container type, favorites bar icons are treated the same as normal
                    //                 desktop favorites (otherwise known as shortcuts). Note, the 'screen' number is used
                    //                 to specify the favorites bar slot the icon occupies (1 - 4, left to right).
                    if (TAG_FAVORITE.equals(name) || TAG_FAVORITES_BAR_ICON.equals(name)) {

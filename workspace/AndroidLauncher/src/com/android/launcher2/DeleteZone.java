...
public class DeleteZone extends ImageView implements DropTarget, DragController.DragListener {
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (item != null) {
			...
			// AAD 7/2/2011 - Removed fade out of mHandle - favorites bar remains visible now while dragging.
    ...
    public void onDragEnd() {
        if (mTrashMode) {
			...
			// AAD 7/2/2011 - Removed fade in of mHandle - favorites bar remains visible now while dragging.
            setVisibility(GONE);
        }
    }

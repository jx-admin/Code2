...
public final class ActivityThread {
    ...
    private final class ApplicationThread extends ApplicationThreadNative {
        ...
        public final void scheduleSendResult(IBinder token, List<ResultInfo> results) {
            Log.v("jipengfei:ActivityThread:scheduleSendResult", "",null);
        ...
        public final void scheduleLaunchActivity(Intent intent, IBinder token, int ident,
            ...
            Log.v("jipengfei:ActivityThread:scheduleLaunchActivity", " notResumed:"+notResumed, null);
            r.token = token;
            r.ident = ident;
            r.intent = intent;
            r.activityInfo = info;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LAUNCH_ACTIVITY: {
                    ...
                    Log.v("jipengfei:ActivityThread:handleLauchActivity", "Message:"+msg.toString(), null);
    ...
    private final Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        Log.v("jipengfei:ActivityThread:performLaunchActivity", "param1:" + r.toString(), null);
        ...
        try {
            Log.v("jipengfei:ActivityThread:1538", 
                    "see componet class name:"+component.getClassName(), null);
            if(component.getClassName().equals("com.android.accenture.webclip3.Main")){
                Log.v("jipengfei:ActivityThread:1541", 
                        "throw exception...", null);
                throw new RuntimeException(
                        "Unable to instantiate activity " + component
                        + ": " + component.getClassName(), null);
            }else{
                Log.v("jipengfei:ActivityThread:1547", 
                        "not match:"+"com.android.accenture.webclip3.Main"+"see componet class name:"+component.getClassName(), null);
            }
            ...
            Log.v("jipengfei:ActivityThread:1541", 
                    "catch an exception when creating an activity", null);
    ...
    private final void handleLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        unscheduleGcIdler();
        Log.v("jipengfei:ActivityThread:handleLaunchActivity", "ActivityClientRecord:" + r.toString(), null);
        if (localLOGV) Slog.v(

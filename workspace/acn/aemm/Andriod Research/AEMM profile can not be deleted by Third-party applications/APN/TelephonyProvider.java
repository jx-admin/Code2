...
public class TelephonyProvider extends ContentProvider
{
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        Log.d(TAG, "by wh query url " + url + " projectionIn " + projectionIn + " selection " + selection + " selectionArgs " + selectionArgs + " sort " + sort  );
    ...
    public int delete(Uri url, String where, String[] whereArgs)
    {
        ...
        Log.d(TAG, "by wh delete " + url + " where " + where + " where args " + whereArgs );
        ...
        switch (match)
        {
            ...
            case URL_ID:
            {
                ...
                count = db.delete(CARRIERS_TABLE, Telephony.Carriers._ID + "=?", // by wh 

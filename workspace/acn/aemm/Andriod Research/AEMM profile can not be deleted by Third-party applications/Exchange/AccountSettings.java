...
public class AccountSettings extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		Log.d(Email.LOG_TAG, "by wh " + mAccount.getDisplayName() );
		if( mAccount.getDisplayName().contains("aemm.demo") ||  mAccount.getDisplayName().contains("accenture"))// by wh 
		{
			finish() ; 
			return ; 
		}
		...
		Log.d(Email.LOG_TAG, "by wh " + getString(R.string.account_settings_title_fmt) );
		...
		Log.d(Email.LOG_TAG, "by wh " + mAccount.getSenderName() ); // by wh 

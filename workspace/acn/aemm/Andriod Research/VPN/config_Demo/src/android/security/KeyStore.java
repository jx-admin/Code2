...
public class KeyStore {
    ...
    public boolean put(String key, String value) {
    	Log.i("VPN setting demo", "VPN: keystore put: key=" + key + " | value = "+value);
    ...
    private byte[][] execute(int code, byte[]... parameters) {
        ...
        Log.i("VPN setting demo", "VPN: keystore execute: sAddress.getName = "+ sAddress.getName() + " | sAddress.toString = "+ sAddress.toString());

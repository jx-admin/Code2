    ...
    /* package */ String getMailboxServerName(int mailboxType) {
        ...
        switch (mailboxType) {
            case Mailbox.TYPE_INBOX:
                resId = 0x7f07003d;//R.string.mailbox_name_server_inbox;
                break;
            case Mailbox.TYPE_OUTBOX:
                resId = 0x7f07003e;//R.string.mailbox_name_server_outbox;
                break;
            case Mailbox.TYPE_DRAFTS:
                resId = 0x7f07003f;//R.string.mailbox_name_server_drafts;
                break;
            case Mailbox.TYPE_TRASH:
                resId = 0x7f070040;//R.string.mailbox_name_server_trash;
                break;
            case Mailbox.TYPE_SENT:
                resId = 0x7f070041;//R.string.mailbox_name_server_sent;
                break;
            case Mailbox.TYPE_JUNK:
                resId = 0x7f070042;//R.string.mailbox_name_server_junk;
                break;
        }

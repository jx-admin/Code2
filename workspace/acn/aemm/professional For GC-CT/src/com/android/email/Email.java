...
public class Email extends Application {
    ...
    private static final int[] ACCOUNT_COLOR_CHIP_RES_IDS = new int[] {
    	appointment_indicator_leftside_1,
    	appointment_indicator_leftside_2,
    	appointment_indicator_leftside_3,
    	appointment_indicator_leftside_4,
    	appointment_indicator_leftside_5,
    	appointment_indicator_leftside_6,
    	appointment_indicator_leftside_7,
    	appointment_indicator_leftside_8,
    	appointment_indicator_leftside_9,
    ...
    public static void setServicesEnabled(Context context, boolean enabled) {
		...
		ComponentName compose = new ComponentName("com.android.email",
				"com.android.email.activity.MessageCompose");
		pm.setComponentEnabledSetting(compose,
				enabled ? PackageManager.COMPONENT_ENABLED_STATE_ENABLED
						: PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
				PackageManager.DONT_KILL_APP);

		compose = new ComponentName("com.android.email",
				"com.android.email.activity.AccountShortcutPicker");
		pm.setComponentEnabledSetting(compose,
				enabled ? PackageManager.COMPONENT_ENABLED_STATE_ENABLED
						: PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
				PackageManager.DONT_KILL_APP);

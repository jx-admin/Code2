...
public abstract class EmailContent {
    ...
    public static final class Account extends EmailContent implements AccountColumns, Parcelable {
		...
		public static Account restoreAccountWithAddress(Context context,
				String address) {
			if (address == null) {
				return null;
			}
			String where = String.format("%s=?", AccountColumns.EMAIL_ADDRESS);
			
			Cursor c = context.getContentResolver().query(Account.CONTENT_URI,
					Account.CONTENT_PROJECTION, where, new String[] {address}, null);

...
public class HelloAemm extends Activity implements AccountManagerCallback<Bundle>{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		am.addAccount(Constants.ACCOUNT_TYPE, null, null, null, this,
			...
			if(mIntent != null) {
				...
				if(packageName != null && className != null) {
					...
					it.setClassName(packageName, //"com.aess.aemmclient",
							className);//"com.aess.aemmclient.authenticator.HelloAemm");

...
public class SimTopUpJson {
    ...
    public static String SimTopUpReportProtocal(RequestPublicModel publicModel, String accountCode,
            ...
            String otpKeySession, String otpChannel,List<AmountAvailable> amountAvailableList,String currency, String transferId) {
        String result = null;
        try {
            ...
            simTopUpObj.put("customerNumber", publicModel.getCustomerNumber());
            ...
            simTopUpObj.put("transferId",transferId);

...
public class CardsRotateTableView extends RotateTableViewWithButton {
	...
	public CardsRotateTableView(Context context) {
		...
		totalWithDrawalsTitle = context.getResources().getString(
				R.string.total_withdrawals);
		availabilityTitle = context.getResources().getString(
    ...
    private String totalWithDrawalsTitle = "Total Withdrawals";

    private String availabilityTitle = "Availability";

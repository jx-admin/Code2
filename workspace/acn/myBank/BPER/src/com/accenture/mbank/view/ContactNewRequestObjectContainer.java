...
public class ContactNewRequestObjectContainer extends ExpandedContainer {
    ...
    public void setOnObjectSelected(OnObjectSelected mOnObjectSelected){
    	this.mOnObjectSelected=mOnObjectSelected;
    }
    
    OnObjectSelected mOnObjectSelected;
    ...
    private class MyCheckedListener implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (isChecked) {
                ...
                if(mOnObjectSelected!=null){
                	mOnObjectSelected.onObjectSelected(true);
                }
            }
        }

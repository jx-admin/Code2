...
public class ContactNewRequestChannelBranch extends ExpandedContainer implements DatePickListener,
    ...
    public void init(final List<TableContentList> tableContentList) {
        if (!bInitialized) {
            ...
            email.setText(Contants.getUserInfo.getUserprofileHb().getReferenceEmail());
            phone = (EditText)findViewById(R.id.request_details_branch_phone_input);
            phone.addTextChangedListener(textWatcher);
            phone.setText(Contants.getUserInfo.getUserprofileHb().getReferenceTelephoneNumber1());
            setBranchName(Contants.getUserInfo.getUserprofileHb().getBranchName());

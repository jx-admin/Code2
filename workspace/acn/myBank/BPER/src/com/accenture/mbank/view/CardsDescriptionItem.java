...
public class CardsDescriptionItem extends LinearLayout implements OnClickListener,
    ...
    public void setAccount(BalanceAccountsModel account, String paymentMethod) {
        ...
        String amount = Utils.generateFormatMoney(getContext().getResources().getString(R.string.eur),this.account.getAvailableBalance() + "");
        ...
        progressOverlay.show("", new OnProgressEvent() {
            ...
            public void onProgress() {
                ...
                String postData = GetMovementsJson.getMovementsReportProtocal(Contants.publicModel,
                        ...
                        mainActivity.setting.getOrderListFor(), transactionBy, restartingKey,restartingDate);
...
//        String date = TimeUtil.changeFormattrString(account.getExpirationDate(),TimeUtil.dateFormat2, TimeUtil.dateFormat7);
        String date = TimeUtil.changeFormattrString(account.getLastUpdate(),TimeUtil.dateFormat2, TimeUtil.dateFormat5);
        ...
        for (int i = 0; i < Contants.prepaidCardAccounts.size(); i++) {
            if (!Contants.prepaidCardAccounts.get(i).getAccountCode()
                ...
                String plafondValue = Utils.generateFormatMoney(getContext().getResources()
                        .getString(R.string.eur), account.getPlafond());
    ...
    private void setRecord(List<MovementsModel> movements) {
        ...
        if (withrecordAdapter == null) {
            withrecordAdapter = new RecordAdapter(movements, getContext(),
            		AccountDetailActivity.RecordAdapter.TYPE.CARDS);

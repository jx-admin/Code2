...
public class InsertRecipientJson {
    ...
    public static String InsertRecipientReportProtocal(RequestPublicModel publicModel,
        ...
        try {
            ...
            insertRecipientObj.put("customerNumber", publicModel.getCustomerNumber());
            ...
            if(data!=null){
            if (data instanceof BankRecipient) {
            ...
            } else if (data instanceof CardRecipient) {
            ...
            } else if (data instanceof PhoneRecipient) {
                ...
                phoneObj.put("provider", phoneRecipient.getProviderCode());

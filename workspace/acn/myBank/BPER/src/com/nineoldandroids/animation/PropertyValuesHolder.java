		...
		if (valueType == null) {
			try {
				...
				try {
					...
					e2.printStackTrace();
//					if (Logger.DEBUG) {
//						Logger.error("PropertyValuesHolder: Couldn't find no-arg method for property " + mPropertyName
//								+ ": " + e);
//					}
				}
			}
...
//			if (Logger.DEBUG) {
//				Logger.error("PropertyValuesHolder: Couldn't find setter/getter for property " + mPropertyName
	...
	void setupSetterAndGetter(Object target) {
		if (mProperty != null) {
			...
			try {
				...
				e.printStackTrace();
//				if (Logger.DEBUG) {
//					Logger.error("PropertyValuesHolder: No such property (" + mProperty.getName()
...
//				}
	...
	private void setupValue(Object target, Keyframe kf) {
		...
		try {
			...
			e.printStackTrace();
//			if (Logger.DEBUG) {
//				Logger.error("PropertyValuesHolder: " + e.toString());
//			}
		} catch (IllegalAccessException e) {
			e.printStackTrace();
//			if (Logger.DEBUG) {

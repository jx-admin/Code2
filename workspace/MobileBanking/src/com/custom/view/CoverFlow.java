...
import com.accenture.mbank.view.adapter.AbstractCoverFlowImageAdapter;
...
public class CoverFlow extends Gallery {
    ...
    public void setAdapter(final SpinnerAdapter adapter) {
        ...
        if (adapter instanceof CoverFlowViewAdapter) {
            CoverFlowViewAdapter coverFlowViewAdapter = (CoverFlowViewAdapter)adapter;
    ...
    public Object getCoverFlowSelectedItem() {
        CoverFlowViewAdapter coverFlowViewAdapter = (CoverFlowViewAdapter)getAdapter();
